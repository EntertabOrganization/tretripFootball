  ...
  return (
    <section className="relative overflow-hidden bg-giddam-secondary py-24 border-t border-white/5">
      <div className="mx-auto max-w-4xl px-4 relative z-10">
        ...
        <div className="rounded-3xl border border-white/10 bg-white/5 p-12 text-center backdrop-blur-sm shadow-2xl">
          <Image 
            src="/TreTrip.svg" 
            alt="TreTrip" 
            width={240} 
          ...
          />
          <p className="mx-auto max-w-2xl text-xl text-white/90 leading-relaxed mb-10">
            {t('partnerDesc')}
          </p>
