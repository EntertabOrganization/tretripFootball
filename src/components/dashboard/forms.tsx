...
export function CategoryCreateForm() {
  return (
    <form action={createCategoryAction} className="grid gap-3 rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <textarea name="descriptionEn" placeholder="Description (EN)" className="min-h-28 rounded-2xl border border-slate-200 px-4 py-3" required />
      <textarea name="descriptionAr" placeholder="Description (AR)" className="min-h-28 rounded-2xl border border-slate-200 px-4 py-3" required />
...
export function NewsCreateForm({ categories }: { categories: NewsCategory[] }) {
  return (
    <form action={createNewsAction} className="grid gap-3 rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <textarea name="contentEn" placeholder="Content (EN)" className="min-h-32 rounded-2xl border border-slate-200 px-4 py-3" required />
      <textarea name="contentAr" placeholder="Content (AR)" className="min-h-32 rounded-2xl border border-slate-200 px-4 py-3" required />
