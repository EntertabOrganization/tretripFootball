...
export const dictionaries = {
  en: {
    ...
    home: {
      ...
      heroTitle: "Qiddam with the same spirit",
      heroBody: "The official national team campaign for the 2026 FIFA World Cup, and be part of the event.",
  ...
  ar: {
    ...
    home: {
      ...
      heroTitle: "قدّم بنفس الروح",
      heroBody: "الحملة الرسمية للمنتخب الوطني إلى كأس العالم 2026، وكن جزءًا من الحدث.",
